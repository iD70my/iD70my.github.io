...
<form action="#" method="post" id="contact_form">
  ...
  <p>
    <label>Subject:<br />
      <input style="color:#777" type="text" size="40" id="contact_subject" name="subject" value="Message From Photo Exhibition" readonly="readonly" />
    </label>
  </p>
  <p>
    <label>Message*:<br />
  ...
  <input class="blink" type="submit" name="submit" value="Send Message" />
</form>
<div class="message-status"></div>
<div class="wrong-status"></div>
